...
## Counterfactual Sythesizing or Causal augmentation
  ...
  - [Counterfactual Samples Synthesizing and Training for Robust Visual Question Answering](https://arxiv.org/pdf/2003.06576.pdf) [1, 5, 6]
      - <details><summary>Maheep's notes </summary>
         In this research paper the author focuses on 2 major approaches, i.e. <br>
...
## Eliminating Bias using Causal Inference
  ...
  - [Unbiased Scene Graph Generation from Biased Training](https://arxiv.org/pdf/2002.11949.pdf) [2, 3, 4]
   ...
   - [Learning Domain Invariant Relationship with zal Variable for Domain Generalization](https://arxiv.org/pdf/2110.01438.pdf) [4, 5]
      - <details><summary>Maheep's Notes</summary>
...
## Causal Explanation
   ...
   - [Meaningful Explanations of Black Box AI Decision Systems](https://ojs.aaai.org//index.php/AAAI/article/view/5050) [1, 3]
      - <details><summary>Maheep's Notes</summary>
  ...
  - [WHEN CAUSAL INTERVENTION MEETS ADVERSARIAL EXAMPLES AND IMAGE MASKING FOR DEEP NEURAL NETWORKS](https://arxiv.org/pdf/1902.03380.pdf) [1, 2, 4, 5]
      - <details><summary>Maheep's notes </summary>
   ...
   - [Counterfactual Visual Explanations](https://arxiv.org/pdf/1904.07451.pdf) [1, 3]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Beyond Trivial Counterfactual Explanations with Diverse Valuable Explanations](https://arxiv.org/pdf/2103.10226.pdf) [1, 3]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [SCOUT: Self-aware Discriminant Counterfactual Explanations](https://arxiv.org/pdf/2004.07769.pdf) [1, 3, 4]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Born Identity Network: Multi-way Counterfactual Map Generation to Explain a Classifier’s Decision](https://arxiv.org/pdf/2011.10381.pdf) [1, 4]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Counterfactual Explanation and Causal Inference In Service of Robustness in Robot Control](https://arxiv.org/pdf/2009.08856.pdf) [5, 6]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Counterfactual Explanation Based on Gradual Construction for Deep Networks](https://arxiv.org/pdf/2008.01897.pdf) [1, 3]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [CoCoX: Generating Conceptual and Counterfactual Explanations via Fault-Lines](https://ojs.aaai.org/index.php/AAAI/article/view/5643/5499) [1, 3, 4]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [CX-ToM: Counterfactual Explanations with Theory-of-Mind for Enhancing Human Trust in Image Recognition Models](https://arxiv.org/pdf/2109.01401.pdf) [1, 3, 4]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [DeDUCE: Generating Counterfactual Explanations At Scale](https://arxiv.org/pdf/2111.15639.pdf) [1, 3, 5]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Designing Counterfactual Generators using Deep Model Inversion](https://arxiv.org/pdf/2109.14274.pdf) [1, 3]
   ...
   - [EXPLAINABLE IMAGE CLASSIFICATION WITH EVIDENCE COUNTERFACTUAL](https://arxiv.org/pdf/2004.07511.pdf) [1]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Explaining Visual Models by Causal Attribution](https://arxiv.org/pdf/1909.08891.pdf) [1]
      - <details><summary>Maheep Notes</summary>
   ...
   - [Explaining the Black-box Smoothly-A Counterfactual Approach](https://arxiv.org/pdf/2101.04230.pdf) [1, 3, 4]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Explaining Classifiers with Causal Concept Effect (CaCE)](https://arxiv.org/pdf/1907.07165.pdf) [1, 4]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Fast Real-time Counterfactual Explanations](https://arxiv.org/pdf/2007.05684.pdf) [1, 4, 5]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [GENERATIVE_COUNTERFACTUAL_INTROSPECTION_FOR_EXPLAINABLE_DEEP_LEARNING](https://arxiv.org/pdf/1907.03077.pdf) [1, 5]
      - <details><summary>Maheep's Notes</summary>  
        The paper propose to generate counterfactual using the Generative Counterfactual Explanation not by replacing a patch of the original image with something but by generating a counterfactual image by replacing minimal attributes unchanged, i.e. A = {a1, a2, a3, a4, a5....an}. It is implemented by: - <br>

        `min(lambda*loss(I(A')) + ||I - I(A'))`, where loss is cross-entropy for predicting image I(A') to label c'.

        </details> 

  - [Generative_Counterfactuals_for_Neural_Networks_via_Attribute_Informed_Perturbations](https://arxiv.org/pdf/2101.06930.pdf) [1, 3, 5]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Contrastive_Counterfactual_Visual_Explanations_With_Overdetermination](https://arxiv.org/pdf/2106.14556.pdf) [1, 3]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Training_calibration‐based_counterfactual_explainers_for_deep_learning](https://www.nature.com/articles/s41598-021-04529-5) [1, 3, 4]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Generating Natural Counterfactual Visual Explanations](https://www.ijcai.org/proceedings/2020/0742.pdf) [1, 3, 6]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [INTERPRETABILITY_THROUGH_INVERTIBILITY_A_DEEP_CONVOLUTIONAL_NETWORK](https://openreview.net/pdf?id=8YFhXYe1Ps) [1, 3, 4, 6]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Discriminative Attribution from Counterfactuals](https://arxiv.org/pdf/2109.13412.pdf) [1, 3]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Proactive Pseudo-Intervention: Contrastive Learning For Interpretable Vision Models](https://arxiv.org/abs/2012.03369) [1, 4, 5]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Latent Space Explanation by Intervention](https://arxiv.org/abs/2112.04895) [1, 4, 5]
      - <details><summary>Maheep's Notes</summary>
...
## Others
  - [How Should Pre-Trained Language Models Be Fine-Tuned Towards Adversarial Robustness?](https://openreview.net/pdf?id=pl2WX3riyiq) [None]
      - <details><summary>Maheep's notes </summary>
   ...
   - [Introspective Distillation for Robust Question Answering](https://arxiv.org/pdf/2111.01026.pdf) [5]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Discovering Causal Signals in Images](https://arxiv.org/abs/1605.08179) [1, 4]
      - <details><summary>Maheep's Notes</summary>
   ...
   - [Causality matters in medical imaging](https://www.nature.com/articles/s41467-020-17478-w) [5]
      - <details><summary>Maheep's Notes</summary>
